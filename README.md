...
To manage the bot via a web interface and view logs, run:

```bash
streamlit run ui.py
```

The instance can be selected with the `BOT_INSTANCE` environment variable. Logs are saved to `bot.log`.
